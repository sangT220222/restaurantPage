const sections = [
  ...
  //DOMContentLoaded is needed as we have an empty html page, so we wait for it to load first then do the script below
  document.addEventListener('DOMContentLoaded', function() {
    ...
    sections.forEach(section => {
      ...
      if(section.content && (section.id === 'home-2' || section.id === 'home-3')) { //for menu section
